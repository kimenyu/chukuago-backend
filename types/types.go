...
const (
	...
	LedgerErrandPayout      LedgerType = "errand_payout"
	LedgerPlatformFee       LedgerType = "platform_fee"
	LedgerRefund            LedgerType = "refund"
	LedgerTip               LedgerType = "tip"
	LedgerWithdrawalRequest LedgerType = "withdrawal_request"
	LedgerWithdrawalPaid    LedgerType = "withdrawal_paid"
...
type WalletLedgerEntry struct {
	...
	Amount      float64        `json:"amount"` // +credit / -debit
	Currency    string         `json:"currency"`
...
type EscrowAccount struct {
	...
	Currency   string    `json:"currency"`
	Status     string    `json:"status"` // held/released/refunded/partial
	CreatedAt  time.Time `json:"createdAt"`
	UpdatedAt  time.Time `json:"updatedAt"`
}
...
type PaymentTransaction struct {
	ID             uuid.UUID      `json:"id"`
	UserID         uuid.UUID      `json:"userId"`
	ErrandID       *uuid.UUID     `json:"errandId,omitempty"`
...
type DisputeEvidence struct {
	...
	EvType    string     `json:"evType"` // photo/file/message/note
